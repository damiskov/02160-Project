...
public class SpriteRobotLaserAnimation2 extends Animation {
	...
	public SpriteRobotLaserAnimation2(int durationMs, Position startingPosition, Position finishPosition, BoardPanel canvasBP, List<ImageToggleSprite> robotLaserSpriteList, int cellWidth) {
		super(durationMs);
