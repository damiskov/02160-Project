...
public class HeartLabel extends JLabel {
	...
	private static ImageIcon fullHeart = new ImageIcon(ImageUtils.scaledImage("/heart.png", 30, 30));
	private static ImageIcon emptyHeart = new ImageIcon(ImageUtils.scaledImage("/empty_heart.png", 30, 30));
