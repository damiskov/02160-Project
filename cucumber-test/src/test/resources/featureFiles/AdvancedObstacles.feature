...
Feature: Advanced obstacles scenarios
  ...
  Scenario: Laser damages
   ...
   # error because "this.context.fire" is null
  ...
  Scenario: Fire damages robot
   ...
   # error, because the step 'a turn passes' is undefined.
  ...
  #Scenario: Reversal panel
    ...
    #error because "this.context.game" is null
  ...
  #Scenario: Chain connection
    ...
    #error because "this.context.robot" is null
